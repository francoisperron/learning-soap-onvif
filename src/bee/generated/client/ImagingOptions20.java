 ...
 *         &lt;element name="IrCutFilterModes" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
...
public class ImagingOptions20 {
    ...
    protected List<String> irCutFilterModes;
     ...
     * 
     */
    public List<String> getIrCutFilterModes() {
        if (irCutFilterModes == null) {
            irCutFilterModes = new ArrayList<String>();
        }
