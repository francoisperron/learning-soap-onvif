 ...
 *         &lt;element name="SupportedMpeg4Profiles" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded"/>
...
public class Mpeg4DecOptions {
    ...
    protected List<String> supportedMpeg4Profiles;
     ...
     * 
     */
    public List<String> getSupportedMpeg4Profiles() {
        if (supportedMpeg4Profiles == null) {
            supportedMpeg4Profiles = new ArrayList<String>();
        }
