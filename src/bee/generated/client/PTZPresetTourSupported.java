 ...
 *         &lt;element name="PTZPresetTourOperation" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/>
...
public class PTZPresetTourSupported {
    ...
    protected List<String> ptzPresetTourOperation;
     ...
     * 
     */
    public List<String> getPTZPresetTourOperation() {
        if (ptzPresetTourOperation == null) {
            ptzPresetTourOperation = new ArrayList<String>();
        }
