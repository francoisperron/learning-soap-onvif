 ...
 *         &lt;element name="SupportedH264Profiles" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded"/>
...
public class H264DecOptions {
    ...
    protected List<String> supportedH264Profiles;
     ...
     * 
     */
    public List<String> getSupportedH264Profiles() {
        if (supportedH264Profiles == null) {
            supportedH264Profiles = new ArrayList<String>();
        }
