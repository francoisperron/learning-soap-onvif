 ...
 *         &lt;element name="H264ProfilesSupported" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class H264Options {
    ...
    protected List<String> h264ProfilesSupported;
     ...
     * 
     */
    public List<String> getH264ProfilesSupported() {
        if (h264ProfilesSupported == null) {
            h264ProfilesSupported = new ArrayList<String>();
        }
