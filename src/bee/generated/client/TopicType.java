 ...
 *       &lt;sequence>
 *         &lt;element name="MessagePattern" type="{http://docs.oasis-open.org/wsn/t-1}QueryExpressionType" minOccurs="0" form="qualified"/>
 *         &lt;element name="Topic" type="{http://docs.oasis-open.org/wsn/t-1}TopicType" maxOccurs="unbounded" minOccurs="0" form="qualified"/>
...
@XmlSeeAlso({
    bee.generated.client.TopicNamespaceType.Topic.class
})
    ...
    extends ExtensibleDocumented
{
    ...
    protected QueryExpressionType2 messagePattern;
     ...
     * @return
     *     possible object is
     *     {@link QueryExpressionType2 }
     *     
     */
    public QueryExpressionType2 getMessagePattern() {
     ...
     *     
     */
    public void setMessagePattern(QueryExpressionType2 value) {
