 ...
 *         &lt;element name="Mpeg4ProfilesSupported" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Mpeg4Options {
    ...
    protected List<String> mpeg4ProfilesSupported;
     ...
     * 
     */
    public List<String> getMpeg4ProfilesSupported() {
        if (mpeg4ProfilesSupported == null) {
            mpeg4ProfilesSupported = new ArrayList<String>();
        }
